...
static struct resource s5p_dm9000_resources[] = {
	[0] = {
		.start = S5P_PA_DM9000,
		.end   = S5P_PA_DM9000 + 3, //‰∏∫‰ªÄ‰πàË¶ÅÂä†Ôºì?
		.flags = IORESOURCE_MEM,
	},
	[1] = {
#if defined(CONFIG_DM9000_16BIT)
		.start = S5P_PA_DM9000 + 4,	//‰∏∫‰ªÄ‰πàË¶ÅÂä†ÔºîÔºü
		.end   = S5P_PA_DM9000 + 7,	//‰∏∫‰ªÄ‰πàË¶ÅÂä†ÔºóÔºü
		.flags = IORESOURCE_MEM,
#else
...
/*
Õ®π˝‘⁄smdkc110_machine_init ÷–s3cfb_set_platdata(&ek070tn93_fb_data)
...
void __init s3cfb_set_platdata(struct s3c_platform_fb *pd)
{
	...
	/*
		“‘œ¬ «ππΩ®npd ,,  ◊Ó÷ÿ“™µƒ «◊Ó∫Û“ªæ‰£¨
	Ω´ndp ∏≥÷µ∏¯s3c_device_fb.dev.platform_data;  ‘⁄«˝∂Ø«˝∂Ø
	≤ø∑÷æÕø…“‘Õ®π˝…Ë±∏µƒplatform_data ¿¥ªÒ»°Ω·ππÃÂ
	s3c_platform_fb µƒ ˝æ›;
	*/
...
#ifdef CONFIG_LEDS_X210

static struct x210_led_platdata x210_led1_pdata = {
	.name		= "led1",
	.gpio		= S5PV210_GPJ0(3),
	.flags		= X210_LEDF_ACTLOW | X210_LEDF_TRISTATE,
	.def_trigger	= "led1_jun",
};
...
static struct x210_led_platdata x210_led4_pdata = {
	...
	.gpio		= S5PV210_GPD0(1),
	.flags		= X210_LEDF_ACTLOW | X210_LEDF_TRISTATE,
	.def_trigger	= "led4_jun",
};



static struct platform_device x210_device_led1 = {
	.name		= "x210_leds",
	.id		= 1,
	.dev		= {
...
static struct platform_device x210_device_led2 = {
	.name		= "x210_leds",
	.id		= 2,
	.dev		= {
...
static struct platform_device x210_device_led3 = {
	.name		= "x210_leds",
	.id		= 3,
	.dev		= {
...
static struct platform_device x210_device_led4 = {
	.name		= "x210_leds",
	.id		= 4,
	.dev		= {
...
static struct x210_led_platdata x210_led_backlight_pdata = {
	.name		= "backlight",
	.gpio		= S3C2410_GPG(4),
	.def_trigger	= "backlight",
};

static struct platform_device x210_led_backlight = {
	.name		= "x210_leds",
	.id		= 5,
	.dev		= {
		.platform_data	= &x210_led_backlight_pdata,
	},
};
