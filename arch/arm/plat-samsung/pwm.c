 ...
 */
/* 在mach-x210.c 中的smdkc110_devices 数组中注册的 */
...
struct pwm_device *pwm_request(int pwm_id, const char *label)
{
	...
	/* 
		初始化时将s3c_device_timer 注册了，然后通过
	注册驱动将pwm_device 都添加到链表pwm_list 中，
	
		与s3c_device_timer 中设备相匹配
	*/
...
static int s3c_pwm_probe(struct platform_device *pdev)
{
	...
	/*在pwm-clock.c 中struct clk clk_tin[]*/
	...
	/*
		注册pwm 设备，并将所有的pwm_device
	添加到链表pwm_list 中，为遍历pwm_device
	作准备
	*/
...
static int __init pwm_init(void)
{
	...
	/*  pwm-scaler0   对应的  clk_timer_scaler  , 在pwm-clock.c 中注册了 */
