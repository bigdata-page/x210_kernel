...
{
	/*
		wm8976_socdev 全局变量在wm8976_probe 中赋值
	*/
	struct snd_soc_device *socdev = wm8976_socdev;	

	/*
	在 wm8976_socdev 中给cdev->card->codec 赋值了
...
static int wm8976_probe(struct platform_device *pdev)
{
	...
	*/
	...
	/*
		socdev->codec_data = 	s3c6410_wm8976_setup
	*/
