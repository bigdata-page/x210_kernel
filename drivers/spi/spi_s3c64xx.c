...
static int __init s3c64xx_spi_probe(struct platform_device *pdev)
{
	...
	/*
		pdev->dev.platform_data == s5pv210_spi0_pdata
		或者
		pdev->dev.platform_data == s5pv210_spi1_pdata
	*/
	...
	/* 
		pdev  == s5pv210_device_spi0 或则s5pv210_device_spi1 	
	*/
	...
	/*   pdev->dev.platform_data  ==  s5pv210_spi0_pdata 或者s5pv210_spi1_pdata*/
